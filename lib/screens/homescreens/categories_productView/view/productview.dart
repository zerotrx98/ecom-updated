...
import '../cntrl/categories_product.dart';

class BrowseCategoriesproductView extends StatelessWidget {
  final CategoriesWise productController = Get.put(CategoriesWise());
