...
class ProductAll {
  ...
  factory ProductAll.fromRawJson(String str) => ProductAll.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ProductAll.fromJson(Map<String, dynamic> json) => ProductAll(products: json["products"] == null ? [] : List<Product>.from(json["products"]!.map((x) => Product.fromJson(x))), status: json["status"],);
...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) => Product(
    ...
    mrpp: json["mrpp"],
    sellp: json["sellp"],
    isproductcliked: json["isproductcliked"],
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "mrpp": mrpp,
    "sellp": sellp,
    "isproductcliked": isproductcliked,
  };
}
