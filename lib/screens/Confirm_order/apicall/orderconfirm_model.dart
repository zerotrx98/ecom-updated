...
class AddressControl {
  ...
  factory AddressControl.fromRawJson(String str) => AddressControl.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory AddressControl.fromJson(Map<String, dynamic> json) => AddressControl(
